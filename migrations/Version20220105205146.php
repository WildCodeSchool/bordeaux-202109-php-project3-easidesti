 ...
 */
final class Version20220105205146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, is_easi TINYINT(1) NOT NULL, step INT NOT NULL, error_count INT DEFAULT NULL, help_count INT DEFAULT NULL, score INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, error_step INT NOT NULL, INDEX IDX_232B318C99E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE game_letter (game_id INT NOT NULL, letter_id INT NOT NULL, INDEX IDX_F33743C2E48FD905 (game_id), INDEX IDX_F33743C24525FF26 (letter_id), PRIMARY KEY(game_id, letter_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE serie (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, number INT NOT NULL, level INT NOT NULL, INDEX IDX_AA3A9334E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE game_letter ADD CONSTRAINT FK_F33743C2E48FD905 FOREIGN KEY (game_id) REFERENCES game (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_letter ADD CONSTRAINT FK_F33743C24525FF26 FOREIGN KEY (letter_id) REFERENCES letter (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE serie ADD CONSTRAINT FK_AA3A9334E48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game_letter DROP FOREIGN KEY FK_F33743C2E48FD905');
        $this->addSql('ALTER TABLE game_word DROP FOREIGN KEY FK_28E4193DE48FD905');
        $this->addSql('ALTER TABLE serie DROP FOREIGN KEY FK_AA3A9334E48FD905');
        $this->addSql('ALTER TABLE game_letter DROP FOREIGN KEY FK_F33743C24525FF26');
