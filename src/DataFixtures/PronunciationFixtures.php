...
class PronunciationFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $pronunciation->setPicture('lettre_a_1.png');
        ...
        $pronunciation2->setPicture('lettre_a_6.png');
        ...
        $pronunciation3->setPicture('lettre_a_3.png');
        ...
        $pronunciation4->setPicture('lettre_a_5.png');
        ...
        $pronunciation6->setPicture('lettre_a_4.png');
